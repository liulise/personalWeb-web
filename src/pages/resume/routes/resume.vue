			...
			<section class="Rcover_resume">
				<div class="main">
					<article>
						<header>教育背景</header>
						<p>
							2012.06-2016.06 重庆三峡学院 信息与计算机科学
						</p>
					</article>
					...
					<article>
						<header>技能树 </header>
						<p>1. html,css,js,html5,css3 </p>
						<p>2. jquery,echarts,elementUi </p>
						<p>3. vue（1.x--2.x）,vue-router,vuex，vue-resource </p>
						<p>4. gulp,webpack(1.x--2.x) </p>
						<p>5. es6 </p>
						<p>6. node.js,express,mongodb(正在使用这个做个人网站后台) </p>
						<p>7. 部分js设计模式 </p>
						<p>8. git版本控制</p>
						<p>9. sass预处理</p>
					</article>
					...
					<article>
						<header>自我评价 </header>
						<p>
							&emsp;&emsp;我的前端生涯开始于2015年8月份，相比于大多数同学大一大二开始学习，我进入圈子的时间较之稍晚，也由于学校没有相应课程，以致于我走了不少弯路.
						</p>
						<p>
							&emsp;&emsp;但由于对前端，不，应该是全栈抱有极其浓烈的学习欲望， 我于2015年11月2日进入公司，迄今工作<b>16</b>个月掌握了以上技能（现龄22岁） 。作为公司<b>唯一</b>的前端，我在没有人带领的情况下，不断专研各个前端技术，并不断改善公司代 码，并深入模块化，工程化，独自完成一整个大型项目的前端开发，引入webpack等构建工 具，目前已完成大概<b>25</b>个页面左右（单页，多页都有）。由于公司业务是做监控系统，因此每 一个页面都包含着<b>大量</b>数据交互，逻辑控制。我相信我能够很快适应新公司的节奏并胜任前端的职位。
						</p>
					</article>
				</div>
			</section>
