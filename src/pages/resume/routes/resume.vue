			...
			<section class="Rcover_resume">
				<div class="main">
					...
					<article>
						...
						<p>5. es6 </p>
						<p>6. 了解node.js,express,mongodb(正在使用这个做个人网站后台) </p>
						<p>7. 部分js设计模式 </p>
						<p>8. git版本控制</p>
						<p>9. sass预处理</p>
					</article>
					...
					<article>
						<header>自我评价 </header>
						<p>
							&emsp;&emsp;从大三开始接触前端，我便深深的爱上了这门技术，翻阅了多本书籍。 也因此于2015年 11月进入公司，便直接扛上了前端主力的责任，负责公司整个项目近23个 页面的开发（其中一 个项目）。作为公司唯一的前端，我深入模块化，并采用gulp,webpack等脚手架工具。 
						</p>
						<p>
							&emsp;&emsp;我追求前沿技术，在vue1时便开始使用，目前已熟练掌握vue技术栈。 
						</p>
						<p>
							&emsp;&emsp;我相信只有在兴趣的带领下，才能迅速前进。 给我一个机会，我还你一片辉煌。
						</p>
					</article>
				</div>
			</section>
